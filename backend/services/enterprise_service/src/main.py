"""
Enterprise Service - Main Entrypoint
...
from backend.services.enterprise_service.src.config import settings
from backend.services.enterprise_service.src.dependencies import db_manager, kafka_manager, redis_client
from backend.services.enterprise_service.src.routers import enterprise
...
async def lifespan(app: FastAPI):
    # Startup
    logger.info("Starting up Enterprise Service...")
...
app = FastAPI(
    title="AgriDecision AI - Enterprise Service",
    description="Multi-Tenant SaaS, FPO/Cooperative Management & B2B Integrations",
    version="1.0.0",
    lifespan=lifespan,
    docs_url="/v1/docs",
