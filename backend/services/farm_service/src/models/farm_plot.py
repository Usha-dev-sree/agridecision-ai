...
class FarmPlot(Base):
    ...
    # Relationships
    boundary: Mapped[PlotBoundary] = relationship("PlotBoundary", back_populates="plot", uselist=False, cascade="all, delete-orphan")  # noqa: F821
    soil_profile: Mapped[SoilProfile] = relationship("SoilProfile", back_populates="plot", uselist=False, cascade="all, delete-orphan")  # noqa: F821
    seasons: Mapped[list[CropSeason]] = relationship("CropSeason", back_populates="plot", cascade="all, delete-orphan")  # noqa: F821
    devices: Mapped[list[IoTDevice]] = relationship("IoTDevice", back_populates="plot")  # noqa: F821
