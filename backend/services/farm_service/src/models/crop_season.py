...
class CropSeason(Base):
    ...
    crop_variety: Mapped[Optional[str]] = mapped_column(String(100))
    ...
    target_yield_kg: Mapped[Optional[Decimal]] = mapped_column(Numeric(10, 2))
    ...
    plot: Mapped["FarmPlot"] = relationship("FarmPlot", back_populates="seasons")
