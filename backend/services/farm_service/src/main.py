...
from backend.services.farm_service.src.dependencies import db_manager, kafka_manager, redis_client
from backend.services.farm_service.src.routers import boundaries, devices, plots, seasons, soil
...
async def lifespan(app: FastAPI):
    # Startup
    logger.info("Starting up Farm Service...")
...
app = FastAPI(
    title="AgriDecision AI - Farm Service",
    description="Farm Plot, GIS Boundary, Soil, and Device Management",
    version="1.0.0",
    lifespan=lifespan,
    docs_url="/v1/docs",
