"""
Financial Service - Main Entrypoint
...
async def lifespan(app: FastAPI):
    # Startup
    logger.info("Starting up Financial Service...")
...
app = FastAPI(
    title="AgriDecision AI - Financial Service",
    description="Farm Revenue Tracking, Expense Logging, Loan & Subsidy Management",
    version="1.0.0",
    lifespan=lifespan,
    docs_url="/v1/docs",
