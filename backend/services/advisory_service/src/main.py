"""
Advisory Service - Main Entrypoint
...
from backend.services.advisory_service.src.dependencies import db_manager, kafka_manager, redis_client
from backend.services.advisory_service.src.routers import diagnosis, irrigation, recommendations
...
async def lifespan(app: FastAPI):
    logger.info("Starting up Advisory Service...")
...
app = FastAPI(
    title="AgriDecision AI - Advisory Service",
    description="Crop Recommendations, Irrigation Scheduling (FAO-56 PM), and Plant Disease Diagnosis",
    version="1.0.0",
    lifespan=lifespan,
    docs_url="/v1/docs",
