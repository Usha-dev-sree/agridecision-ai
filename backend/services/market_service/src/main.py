"""
Market Service - Main Entrypoint
...
from backend.services.market_service.src.config import settings
from backend.services.market_service.src.dependencies import db_manager, kafka_manager, redis_client
from backend.services.market_service.src.routers import market
...
async def lifespan(app: FastAPI):
    # Startup
    logger.info("Starting up Market Service...")
...
app = FastAPI(
    title="AgriDecision AI - Market Service",
    description="Mandi Commodity Rates, Price Trends & AI Price Forecasting",
    version="1.0.0",
    lifespan=lifespan,
    docs_url="/v1/docs",
